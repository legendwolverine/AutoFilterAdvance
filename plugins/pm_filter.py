...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.insert(0,
            [
                InlineKeyboardButton("Updates", url="https://t.me/tg_moviesjunction"),
            ]
        )
        btn.insert(1,
            [
                InlineKeyboardButton("", url="https://t.me/KM_updates"),
            ]
        )
        btn.append(
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton("❗𝐔𝐩𝐝𝐚𝐭𝐞𝐬❗", url="https://t.me/KM_Updates"),
        ]
    )
    btn.insert(1,
        [
            InlineKeyboardButton("👾𝐌𝐨𝐯𝐢𝐞 𝐆𝐫𝐨𝐮𝐩👾", url="https://t.me/tg_moviesjunction"),
        ]
    )
